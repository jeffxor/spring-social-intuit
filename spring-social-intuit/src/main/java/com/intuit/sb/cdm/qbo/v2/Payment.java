 ...
 * 
 */
@XmlRootElement(name = "Payment", namespace = "http://www.intuit.com/sb/cdm/v2")
    ...
    implements Serializable, Equals, HashCode
{
    ...
    public boolean equals(ObjectLocator thisLocator, ObjectLocator thatLocator, Object object, EqualsStrategy strategy) {
        ...
        {
            PaymentHeader lhsHeader;
            lhsHeader = this.getHeader();
            PaymentHeader rhsHeader;
        ...
        {
            List<PaymentLine> lhsLine;
            lhsLine = this.getLine();
            List<PaymentLine> rhsLine;
